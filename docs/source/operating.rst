...
.. important::
   docker run -d -p 48547:48547 -p 35269:35269 -p 57647:57647 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=project2-f224 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-project2-f224 \-\-env GITUSERNAME=chiraghanda  \-\-env GITREPOURL=https://github.com/chiraghanda/raspberrypi \-\-env SOLUTIONEXTERNALPORT=48547  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=35269  \-\-env SOLUTIONVIPERVIZPORT=57647 \-\-env DOCKERUSERNAME='chiraghanda' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT= \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='chiraghanda22@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  chiraghanda/project2-f224-amd64
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=48547, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=37329, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41329, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40835, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=39631, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=34755, HPDEHOST=127.0.1.1, HPDEPORT=33485, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=34115

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3119-project2-f224,solution_preprocessing_ai_mqtt_dag-project2-f224, python-preprocess-1004-project2-f224,solution_preprocessing_ai_mqtt_dag-project2-f224, python-ai-7842-project2-f224,solution_preprocessing_ai_mqtt_dag-project2-f224, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
