[project2-f224] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [project2-f224] container is NOT running**.

.. tip::
   You must have your [project2-f224] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   chiraghanda/project2-f224-amd64 (https://hub.docker.com/r/chiraghanda/project2-f224-amd64)
...
.. code-block::
   ...
   docker run -d -p 37743:37743 -p 47369:47369 -p 52805:52805 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=project2-f224 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-project2-f224 \-\-env GITUSERNAME=chiraghanda  \-\-env GITREPOURL=https://github.com/chiraghanda/raspberrypi \-\-env SOLUTIONEXTERNALPORT=37743  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=47369  \-\-env SOLUTIONVIPERVIZPORT=52805 \-\-env DOCKERUSERNAME='chiraghanda' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=38675 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  chiraghanda/project2-f224-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - chiraghanda/project2-f224-amd64
...
[project2-f224] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/chiraghanda/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/project2-f224
...
.. important::
   https://project2-f224.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-project2-f224
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=37743, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44957, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=39221, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=44337, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33455, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=33711, HPDEHOST=127.0.1.1, HPDEPORT=40659, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=45513

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7716-project2-f224,solution_preprocessing_ai_mqtt_dag-project2-f224, python-preprocess-5074-project2-f224,solution_preprocessing_ai_mqtt_dag-project2-f224, python-ai-7524-project2-f224,solution_preprocessing_ai_mqtt_dag-project2-f224, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
